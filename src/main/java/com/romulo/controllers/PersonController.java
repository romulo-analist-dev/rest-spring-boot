...
import com.romulo.services.PersonServices;
import com.romulo.util.MediaType;
...
public class PersonController {
	...
	@PostMapping(value = "/v2", produces = { MediaType.APPLICATION_JSON, MediaType.APPLICATION_JSON }, consumes = {
